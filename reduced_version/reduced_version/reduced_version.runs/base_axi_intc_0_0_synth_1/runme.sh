...
HD_PWD='D:/ESD/ESD_CP/PYNQ-image_v2.7/PYNQ-image_v2.7/boards/Pynq-Z2/base/reduced_version/reduced_version.runs/base_axi_intc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_intc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_intc_0_0.tcl
